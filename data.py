...
st.markdown(f'<h1 style="color:#fafdfa;font-size:15px;">{"Impuesto a la Renta (IR). (2022). Orientación - Superintendencia Nacional de Aduanas y de Administración Tributaria - Gobierno del Perú."}</h1>', unsafe_allow_html=True)
st.write("[https://www.gob.pe/664-impuesto-a-la-renta-ir](https://www.gob.pe/664-impuesto-a-la-renta-ir)")    
st.markdown(f'<h1 style="color:#fafdfa;font-size:15px;">{"Calcular el Impuesto a la Renta de primera categoría. (2022). Orientación - Superintendencia Nacional de Aduanas y de Administración Tributaria - Gobierno del Perú."}</h1>', unsafe_allow_html=True)
...
st.markdown(f'<h1 style="color:#fafdfa;font-size:15px;">{"Calcular el impuesto a la renta de segunda categoría por venta de inmuebles. (2022). Orientación - Superintendencia Nacional de Aduanas y de Administración Tributaria - Gobierno del Perú."}</h1>', unsafe_allow_html=True)
...
st.markdown(f'<h1 style="color:#fafdfa;font-size:15px;">{"Calcular el impuesto a la renta de cuarta categoría. (2022). Orientación - Superintendencia Nacional de Aduanas y de Administración Tributaria - Gobierno del Perú."}</h1>', unsafe_allow_html=True)
...
st.markdown(f'<h1 style="color:#fafdfa;font-size:15px;">{"Calcular el impuesto a la renta de quinta categoría. (2022). Orientación - Superintendencia Nacional de Aduanas y de Administración Tributaria - Gobierno del Perú."}</h1>', unsafe_allow_html=True)
