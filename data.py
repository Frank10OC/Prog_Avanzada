...
st.markdown(f'<h1 style="color:#fafdfa;font-size:15px;">{"Fuente de datos: [link](https://www.datosabiertos.gob.pe/dataset/%C3%ADndices-soberanos-2010-2022)"}</h1>', unsafe_allow_html=True)
st.write("check out this [link](https://www.datosabiertos.gob.pe/dataset/%C3%ADndices-soberanos-2010-2022)")     
#IMPORTANDO DATOS
def load_data():
